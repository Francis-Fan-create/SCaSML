...
if os.path.exists(r"results/Sine_Gordon/250d/model_weights_Adam_LBFGS.params"):
    ...
    #train the model
    trained_model=optimizer.train(r"results/Sine_Gordon/250d/model_weights_Adam_LBFGS.params")
