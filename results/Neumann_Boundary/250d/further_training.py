...
#initialize wandb
wandb.init(project="Neumann_Boundary", notes="250 d", tags=["L_inf training"],mode="disabled") #debug mode
# wandb.init(project="Neumann_Boundary", notes="250 d", tags=["L_inf training"]) #working mode
