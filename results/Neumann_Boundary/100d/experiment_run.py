...
if os.path.exists(r"results/Neumann_Boundary/100d/model_weights_Adam_LBFGS.params"):
    ...
    #train the model
    trained_model=optimizer.train(r"results/Neumann_Boundary/100d/model_weights_Adam_LBFGS.params")
