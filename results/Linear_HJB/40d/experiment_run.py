...
if os.path.exists(r"results/Linear_HJB/40d/model.ckpt-?"):
    ...
    model.restore(r"results/Linear_HJB/40d/model.ckpt-?",verbose=1)
...
# rhomax=test1.test(r"results/Linear_HJB/40d")
