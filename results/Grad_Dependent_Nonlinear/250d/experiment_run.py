...
if os.path.exists(r"results/Grad_Dependent_Nonlinear/250d/model_weights_L_inf.params"):
    ...
    net.load_state_dict(torch.load(r"results/Grad_Dependent_Nonlinear/250d/model_weights_L_inf.params",map_location=device)) #the other indexes are left for external resources of weights
    trained_net=net
    is_train = False
else:
