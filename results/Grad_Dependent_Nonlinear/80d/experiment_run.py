...
if os.path.exists(r"results/Grad_Dependent_Nonlinear/80d/model.ckpt-?"):
    ...
    model.restore(r"results/Grad_Dependent_Nonlinear/80d/model.ckpt-?",verbose=1)
...
test5.test(r"results/Grad_Dependent_Nonlinear/80d", budget_levels=[1.0,2.0,4.0])
#run the test for RepeatedExperiment
test6=RepeatedExperiment(equation,solver1_2,solver2,solver3_2,is_train)
test6.test(r"results/Grad_Dependent_Nonlinear/80d", num_repetitions=10)
