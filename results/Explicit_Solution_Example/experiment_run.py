...
if os.path.exists(r"results/Explicit_Solution_Example/model_weights_4.params"):
    ...
    net.load_state_dict(torch.load(r"results/Explicit_Solution_Example/model_weights_4.params",map_location=device)) #the other indexes are left for external resources of weights
    trained_net=net
else:
    ...
    #train the model
    trained_model=optimizer.train("results/Explicit_Solution_Example/model_weights_4.params")
