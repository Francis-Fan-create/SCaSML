...
from equations.equations import Explict_Solution_Example_Rescale
...
equation=Explict_Solution_Example_Rescale(n_input=101,n_output=1)
...
rhomax=test.test(r"results/Explicit_Solution_Example_Rescale")
#stop the profiler
profiler.disable()
#save the profiler results
profiler.dump_stats(f"results/Explicit_Solution_Example_Rescale/explicit_solution_example_rescale_profiler_rho_{rhomax}.prof")
#upload the profiler results to wandb
artifact=wandb.Artifact(f"explicit_solution_example_rescale_profiler_rho_{rhomax}", type="profile")
artifact.add_file(f"results/Explicit_Solution_Example_Rescale/explicit_solution_example_rescale_profiler_rho_{rhomax}.prof")
