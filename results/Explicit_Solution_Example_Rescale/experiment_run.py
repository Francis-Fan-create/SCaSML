...
#initialize wandb
wandb.init(project="Explicit_Solution_Example_Rescale", notes="250 d", tags=["normal sphere test","Adam-LBFGS training"],mode="disabled") #debug mode
# wandb.init(project="Explicit_Solution_Example_Rescale", notes="250 d", tags=["normal sphere test","L_inf training"]) #working mode
...
if os.path.exists(r"results/Explicit_Solution_Example_Rescale/model_weights_4.params"):
    ...
    net.load_state_dict(torch.load(r"results/Explicit_Solution_Example_Rescale/model_weights_4.params",map_location=device)) #the other indexes are left for external resources of weights
    trained_net=net
else:
    ...
    #train the model
    trained_model=optimizer.train(r"results/Explicit_Solution_Example_Rescale/model_weights_4.params")
