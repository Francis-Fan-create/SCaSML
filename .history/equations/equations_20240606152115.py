...
class Equation(object):
    ...
    def mu(self, x_t):
        #drift coefficient in PDE, usually
        raise NotImplementedError
    def sigma(self, x_t):
        #diffusion coefficient in PDE
        raise NotImplementedError
    def f(self, x_t):
        #generator term in PDE
        raise NotImplementedError
    ...
    def boundary_condition(self):
        ...
        if hasattr(self, 'boundary_loss') and hasattr(self, 'geometry'):
            bc=dde.icbc.DirichletBC(self.geometry(),self.boundary_loss, lambda _, on_boundary: on_boundary) #need to be enforced on generate_data method
