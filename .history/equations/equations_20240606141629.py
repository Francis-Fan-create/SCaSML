...
class Equation(object):
    ...
    def terminal_condition(self):
        ...
        if hasattr(self, 'terminal_loss') and hasattr(self, 'geometry'):
            ic=dde.icbc.IC(self.geometry(),self.terminal_loss, lambda _, on_terminal: on_terminal)
