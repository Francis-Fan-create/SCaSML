...
class MLP(object):
    ...
    def approxparameters(self,rhomax):
        ...
        self.Mf, self.Mg, self.Q, self.c, self.w, self.n = Mf, Mg, Q, c, w, n
    ...
    def approximateUZpde(self,n, rho, x_t): 
        ...
        x=x_t[:, :-1]
        t=x_t[:, -1]
       cloc = (self.T-t).unsqueeze(-1).unsqueeze(-1) * self.c/self.T
        wloc = (self.T-t).unsqueeze(-1).unsqueeze(-1) * self.w/self.T
        MC = int(Mg[rho-1, n])
