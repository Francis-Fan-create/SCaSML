...
class ScaML(object):
    ...
    def __init__(self, equation,net,dt_approx=True):
        ...
        self.net=net
        self.dt=(self.T-self.t0)/self.n_input #time step to approximate nonlinear operator, such as laplacian

    def approx_PDE_loss(self,x_t,u,z):
        # PDE loss by plug, using disretization instead of autodiff to accelerate the inferrence
