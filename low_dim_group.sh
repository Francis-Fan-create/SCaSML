...
python results/Diffusion_Reaction/20d/experiment_run.py &
wait
...
python results_full_history/Diffusion_Reaction/20d/experiment_run.py &
wait
echo "Group 3 completed."

# Group 4
echo "Running Group 4"
python results/Diffusion_Reaction/40d/experiment_run.py &
python results_full_history/Diffusion_Reaction/40d/experiment_run.py &
wait
