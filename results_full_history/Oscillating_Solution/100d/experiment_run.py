...
# test1.test(r"results_full_history/Oscillating_Solution/100d")
...
# test3.test(r"results_full_history/Oscillating_Solution/100d")
#run the test for RepeatedExperiment
test4=RepeatedExperiment(equation,solver1_2,solver2,solver3_2,is_train)
test4.test(r"results_full_history/Oscillating_Solution/100d", num_repetitions=10)
...
test5.test(r"results_full_history/Oscillating_Solution/100d", budget_levels=[1.0,2.0,4.0])
