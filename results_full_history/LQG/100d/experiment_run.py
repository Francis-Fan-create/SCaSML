...
# test1.test(r"results_full_history/LQG/100d")
...
test4.test(r"results_full_history/LQG/100d", num_repetitions=10)
...
test5.test(r"results_full_history/LQG/100d", budget_levels=[1.0,2.0,4.0])
