...
#initialize wandb
wandb.init(project="Neumann_Boundary", notes="250 d", tags=["Adam_LBFGS training"],mode="disabled") #debug mode
# wandb.init(project="Neumann_Boundary", notes="250 d", tags=["Adam_LBFGS training"]) #working mode
