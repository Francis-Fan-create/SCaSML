...
#initialize wandb
wandb.init(project="Neumann_Boundary", notes="100 d", tags=["Adam training","L_inf_training"],mode="disabled") #debug mode
# wandb.init(project="Neumann_Boundary", notes="100 d", tags=["Adam training","L_inf_training"]) #working mode
...
if os.path.exists(r"results/Neumann_Boundary/250d/model.ckpt-?"):
    ...
    model.restore(r"results/Neumann_Boundary/250d/model.ckpt-?",verbose=1)
