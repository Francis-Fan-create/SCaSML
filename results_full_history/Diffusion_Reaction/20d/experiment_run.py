...
if os.path.exists(r"results_full_history/Diffusion_Reaction/20d/model.ckpt-?"):
    ...
    model.restore(r"results_full_history/Diffusion_Reaction/20d/model.ckpt-?",verbose=1)
...
test2.test(r"results_full_history/Diffusion_Reaction/20d")
