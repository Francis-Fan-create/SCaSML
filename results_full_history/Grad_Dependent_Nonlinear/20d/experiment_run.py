...
if os.path.exists(r"results_full_history/Grad_Dependent_Nonlinear/20d/model.ckpt-?"):
    ...
    model.restore(r"results_full_history/Grad_Dependent_Nonlinear/20d/model.ckpt-?",verbose=1)
