...
if os.path.exists(r"results_full_history/Grad_Dependent_Nonlinear/100d/model.ckpt-?"):
    ...
    model.restore(r"results_full_history/Grad_Dependent_Nonlinear/100d/model.ckpt-?",verbose=1)
