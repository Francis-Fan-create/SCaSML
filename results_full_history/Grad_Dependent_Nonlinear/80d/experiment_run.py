...
#initialize wandb
wandb.init(project="Grad_Dependent_Nonlinear", notes="80 d", tags=["Adam training","L_inf_training"],mode="disabled") #debug mode
# wandb.init(project="Grad_Dependent_Nonlinear", notes="80 d", tags=["Adam training","L_inf_training"]) #working mode
...
if os.path.exists(r"results_full_history/Grad_Dependent_Nonlinear/80d/model.ckpt-?"):
    ...
    model.restore(r"results_full_history/Grad_Dependent_Nonlinear/80d/model.ckpt-?",verbose=1)
...
# test1.test(r"results_full_history/Grad_Dependent_Nonlinear/80d")
# #run the test for ConvergenceRate
# test2=ConvergenceRate(equation,solver1_2,solver2,solver3_2, is_train)
# test2.test(r"results_full_history/Grad_Dependent_Nonlinear/80d")
...
test6.test(r"results_full_history/Grad_Dependent_Nonlinear/80d", num_repetitions=10)
test7=ComputingBudgetModelScaling(equation,solver1_2,solver2,solver3_2,is_train)
test7.test(r"results_full_history/Grad_Dependent_Nonlinear/80d", budget_levels=[1.0,2.0,4.0])
