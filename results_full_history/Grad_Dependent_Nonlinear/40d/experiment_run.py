...
#initialize wandb
wandb.init(project="Grad_Dependent_Nonlinear", notes="40 d", tags=["Adam training","L_inf_training"],mode="disabled") #debug mode
# wandb.init(project="Grad_Dependent_Nonlinear", notes="40 d", tags=["Adam training","L_inf_training"]) #working mode
...
if os.path.exists(r"results_full_history/Grad_Dependent_Nonlinear/40d/model.ckpt-?"):
    ...
    model.restore(r"results_full_history/Grad_Dependent_Nonlinear/40d/model.ckpt-?",verbose=1)
