...
#initialize wandb
wandb.init(project="Complicated_HJB", notes="250 d", tags=["L_inf training"],mode="disabled") #debug mode
# wandb.init(project="Complicated_HJB", notes="250 d", tags=["L_inf training"]) #working mode
