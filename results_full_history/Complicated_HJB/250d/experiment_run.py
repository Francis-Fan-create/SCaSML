...
#initialize wandb
wandb.init(project="Complicated_HJB", notes="250 d", tags=["Adam_LBFGS training"],mode="disabled") #debug mode
# wandb.init(project="Complicated_HJB", notes="250 d", tags=["Adam_LBFGS training"]) #working mode
