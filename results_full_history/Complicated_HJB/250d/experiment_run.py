...
if os.path.exists(r"results_full_history/Complicated_HJB/250d/model_weights_Adam_LBFGS.params"):
    ...
    #train the model
    trained_model=optimizer.train(r"results_full_history/Complicated_HJB/250d/model_weights_Adam_LBFGS.params")
