...
if os.path.exists(r"results_full_history/Linear_HJB/250d/model.ckpt-?"):
    ...
    model.restore(r"results_full_history/Linear_HJB/250d/model.ckpt-?",verbose=1)
