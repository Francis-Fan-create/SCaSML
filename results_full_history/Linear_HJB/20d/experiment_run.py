...
#initialize wandb
wandb.init(project="Linear_HJB", notes="20 d", tags=["Adam training","L_inf_training"],mode="disabled") #debug mode
# wandb.init(project="Linear_HJB", notes="20 d", tags=["Adam training","L_inf_training"]) #working mode
...
if os.path.exists(r"results_full_history/Linear_HJB/20d/model.ckpt-?"):
    ...
    model.restore(r"results_full_history/Linear_HJB/20d/model.ckpt-?",verbose=1)
...
test4.test(r"results_full_history/Linear_HJB/20d")
