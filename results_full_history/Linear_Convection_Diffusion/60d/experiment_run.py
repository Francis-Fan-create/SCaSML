...
#initialize wandb
wandb.init(project="Linear_Convection_Diffusion", notes="60 d", tags=["Adam training","L_inf_training"],mode="disabled") #debug mode
# wandb.init(project="Linear_Convection_Diffusion", notes="60 d", tags=["Adam training","L_inf_training"]) #working mode
...
if os.path.exists(r"results_full_history/Linear_Convection_Diffusion/60d/model.ckpt-?"):
    ...
    model.restore(r"results_full_history/Linear_Convection_Diffusion/60d/model.ckpt-?",verbose=1)
...
test4.test(r"results_full_history/Linear_Convection_Diffusion/60d", num_repetitions=10)
...
test5.test(r"results_full_history/Linear_Convection_Diffusion/60d", budget_levels=[1.0,2.0,4.0])
