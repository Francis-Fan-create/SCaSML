...
# test1.test(r"results_full_history/Linear_Convection_Diffusion/30d")
...
test5.test(r"results_full_history/Linear_Convection_Diffusion/30d", budget_levels=[1.0,2.0,4.0])
